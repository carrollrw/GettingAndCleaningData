...
##
## Getwd() and Setwd() working direcory
##
...
##
##  From the data set in the previou, creates a second, independent tidy data set with the average of each variable for each activity and each subject
##
